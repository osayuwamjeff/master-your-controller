/*
 * Adafruit_ST77xx_Mod.h
 *
 *  Created on: Dec 9, 2024
 *      Author: Jxentech
 */

#ifndef ADAFRUIT_ST77XX_MOD_H_
#define ADAFRUIT_ST77XX_MOD_H_
...
public:
  Adafruit_ST77xx(uint16_t w, uint16_t h, int8_t cs = _CS, int8_t dc = _DC);
