...
public:
  ...
  */
  explicit OV7670(uint8_t addr = OV7670_ADDR, I2C_HandleTypeDef &rhi2c = HI2C);
  ~OV7670(); // Destructor
  ...
  */
  void night(OV7670_night_mode night) { OV7670_night(night); }
  ...
  */
  void flip(bool flip_x, bool flip_y) { OV7670_flip(flip_x, flip_y); }
