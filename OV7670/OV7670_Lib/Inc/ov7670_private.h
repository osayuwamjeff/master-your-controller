...
#ifndef OV7670_PRIVATE_H_
#define OV7670_PRIVATE_H_
...
#define OV7670_delay_ms(x) HAL_Delay(x);

#define VSYNC_GPIO GPIOB		//< VSYNC GPIO Port
#define VSYNC_Pin GPIO_PIN_5	//< VSYNC GPIO Pin
#define PCLK_GPIO GPIOB			//< PCLK GPIO Port
#define PCLK_Pin GPIO_PIN_4		//< PCLK GPIO Pin
#define HREF_GPIO GPIOB			//< HREF GPIO Port
#define HREF_Pin GPIO_PIN_3		//< HREF GPIO Pin
//#define PWDN_GPIO GPIOB			//< PWDN GPIO Port
//#define PWDN_Pin GPIO_PIN_4		//< PWDN GPIO Pin
//#define RESET_GPIO GPIOB			//< RESET GPIO Port
//#define REST_Pin GPIO_PIN_3		//< RESET GPIO Pin

#define D0_GPIO GPIOB			//< D0 GPIO Port
#define D0_Pin GPIO_PIN_8		//< D0 GPIO Pin
#define D1_GPIO GPIOB			//< D1 GPIO Port
#define D1_Pin GPIO_PIN_9		//< D1 GPIO Pin
#define D2_GPIO GPIOB			//< D2 GPIO Port
#define D2_Pin GPIO_PIN_10		//< D2 GPIO Pin
#define D3_GPIO GPIOB			//< D3 GPIO Port
#define D3_Pin GPIO_PIN_11		//< D3 GPIO Pin
#define D4_GPIO GPIOB			//< D4 GPIO Port
#define D4_Pin GPIO_PIN_12		//< D4 GPIO Pin
#define D5_GPIO GPIOB			//< D5 GPIO Port
#define D5_Pin GPIO_PIN_13		//< D5 GPIO Pin
#define D6_GPIO GPIOB			//< D6 GPIO Port
#define D6_Pin GPIO_PIN_14		//< D6 GPIO Pin
#define D7_GPIO GPIOB			//< D7 GPIO Port
#define D7_Pin GPIO_PIN_15		//< D7 GPIO Pin

#define XCLK_GPIO GPIOA
#define XCLK_Pin GPIO_PIN_8
#define OV7670_XCLK_HZ 24000000 ///< XCLK to camera, 8-24 MHz

#define OV7670_READ_PIXEL_BYTE(b) {b = (uint8_t)(HAL_GPIO_ReadPin(D7_GPIO,D7_Pin)<<7 | \
		HAL_GPIO_ReadPin(D6_GPIO,D6_Pin)<<6 | \
		HAL_GPIO_ReadPin(D5_GPIO,D5_Pin)<<5 | \
		HAL_GPIO_ReadPin(D4_GPIO,D4_Pin)<<4 | \
		HAL_GPIO_ReadPin(D3_GPIO,D3_Pin)<<3 | \
		HAL_GPIO_ReadPin(D2_GPIO,D2_Pin)<<2 | \
		HAL_GPIO_ReadPin(D1_GPIO,D1_Pin)<<1 | \
		HAL_GPIO_ReadPin(D0_GPIO,D0_Pin)<<0 );}

#define VSYNC HAL_GPIO_ReadPin(VSYNC_GPIO,VSYNC_Pin)
#define HREF HAL_GPIO_ReadPin(HREF_GPIO,HREF_Pin)
#define PCLK HAL_GPIO_ReadPin(PCLK_GPIO,PCLK_Pin)
...
#define OV7670_ADDR 0x42 //< Default I2C address if unspecified
...
OV7670_status OV7670_begin(OV7670_colorspace colorspace,OV7670_size size, float fps);
...
void OV7670_night(OV7670_night_mode night);

// Flips camera output on horizontal and/or vertical axes.
void OV7670_flip(bool flip_x, bool flip_y);
...
void OV7670_captureLine(uint16_t *dest, uint16_t width);
